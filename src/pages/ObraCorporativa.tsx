      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-8">
          <div className="mb-12">
            ...
            <p className="text-gray-600 text-sm">
              Conheça alguns dos nossos principais projetos para grandes
              corporações
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                <h3 className="text-lg font-bold text-black mb-2">
                  Sede Corporativa Vision
                </h3>
                <p className="text-gray-600 text-xs leading-5 mb-4">
                  Projeto corporativo com conceito open <br />
                  space e certificação LEED.
                </p>
            ...
            <Card className="overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                <h3 className="text-lg font-bold text-black mb-2">
                  Torre Empresarial Horizon
                </h3>
                <p className="text-gray-600 text-xs leading-5 mb-4">
                  Edifício de 20 andares com fachada em <br />
                  vidro e sistema de automação <br />
                  completo.
                </p>
                <div className="flex items-center text-[#1A365D] text-sm font-medium">
                  <span>Ver projeto</span>
            ...
            <Card className="overflow-hidden shadow-lg">
              <div className="relative">
                <img
                  src="/api/placeholder/400/300"
                  alt="Centro Corporativo Excellence"
                  className="w-full h-64 object-cover"
                />
                <div className="absolute inset-0 bg-black/70"></div>
                <div className="absolute bottom-4 left-4">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-xs leading-5 mb-4">
                  Complexo com 3 torres interligadas e <br />
                  praça central de convivência.
                </p>
                <div className="flex items-center text-[#1A365D] text-sm font-medium">
                  <span>Ver projeto</span>
                  <ArrowRight className="w-4 h-4 ml-2" />
